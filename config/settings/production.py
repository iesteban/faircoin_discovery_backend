...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['semillasocial.org'])
...
DEFAULT_FROM_EMAIL = env('DJANGO_DEFAULT_FROM_EMAIL',
                         default='semillas_backend <noreply@semillasocial.org>')
EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[semillas_backend] ')
